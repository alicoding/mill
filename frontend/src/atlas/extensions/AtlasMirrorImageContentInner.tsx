...
// differing only in their fallback glyph -- AtlasMirrorImageContent.tsx's
// makeMirrorImageContent parameterizes that one difference rather than
// branching on Kind at render time. Its own file (goal 0419 S1b): a
// factory's only export must carry no local component-shaped
// declaration for Fast Refresh's own file-shape check.
export function AtlasMirrorImageContentInner({ object, mirrorContent, Glyph }: { object: BoardObject; mirrorContent: MirrorReadState | undefined; Glyph: Icon | null }) {
