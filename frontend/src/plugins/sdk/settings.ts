// A plugin's own settings, declared in the manifest's
// contributes.settings and served back typed. Mill renders the
// controls and stores the values -- a plugin never builds its own
// settings UI.
