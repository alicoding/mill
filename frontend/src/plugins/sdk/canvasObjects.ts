// A canvas object is a plugin's own kind of thing on the board: a
// bookmark, a drawing tool, a mind map. Declaring one adds a tray
// button and a face-rendering contract Mill calls whenever that
// object needs to be drawn or redrawn.
