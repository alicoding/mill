// The API a view's or capture's ENTRY PAGE holds. A page Mill mounts
// in its own frame is not part of Mill's document and shares nothing
// with it, so it reaches Mill through this object and nothing else.
...
export interface MillFrameApi {
   ...
   * `requestGuardedAction`, `context.set`, `runCommand`,
