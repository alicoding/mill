import { DownloadIcon, GitBranchIcon, SyncIcon, UploadIcon, ZapIcon, type Icon } from '@primer/octicons-react'
...
//
// Mill's node kinds are Capture/Process/Apply/Trigger/Decision (SPEC.md
// §2/§3.4/§3.5), not the reference no-code platform's fuller
// Input/Ruleset/... taxonomy (SPEC.md §3.2/ADR-0005) -- most of that
// fuller taxonomy is still real, unbuilt future work (Ruleset/Parallel
...
export const KIND_VARIANT: Record<string, 'accent' | 'success' | 'severe' | 'done' | 'attention'> = {
  trigger: 'done',
  capture: 'accent',
  process: 'success',
  apply: 'severe',
...
// GitBranchIcon for Decision: a routing point with multiple named
