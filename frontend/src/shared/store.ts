...
// The View union and its two derivations live in shared/viewKinds.ts
// (split at the 500-line limit, CLAUDE.md), re-exported here so every
// existing `from '../shared/store'` import keeps working -- the same
// shape workTabs.ts's own split above already takes.
export type { View }
export { viewFor, viewsEqual }
