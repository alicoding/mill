...
import { fillSeries, type GridColumnSort } from './listStandard'
import { optionColor } from './projectionColors'
import { editsByRow, pasteOverflowPatches } from './listGridGlideEdits'
import { runCommand } from './commands'
import { copy } from './copy'

// The non-component half of ListGridGlideOverlays.tsx (goal 0419 S1b):
// the cell-edit callbacks the grid calls, and the props builders
// composed onto <DataEditor>, none of which is itself a component --
// mixing them into a file with AddColumnButton/AddColumnRail/
// GlideOverlays broke react-refresh/only-export-components.

export type Edits = ReturnType<typeof useListSchemaEdits>
