...
//
// The diagram paging/fit commands live in ./atlasDiagramCommands.ts,
// for the same 500-line reason -- spread into ATLAS_BOARD_COMMANDS
// below at the position they always held, so the registry's overall
// order is unchanged.
