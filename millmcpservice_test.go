...
func TestMillMCPService_RealClientRoundTrip(t *testing.T) {
	...
	svc := NewMillMCPService(comp, cfg)
...
// testCredentialStore is a no-op credential.Store for tests that
// construct ConfigureService directly (not through newTestConfigureService)
// and have no need to exercise real keychain behavior.
type testCredentialStore struct{}

func (testCredentialStore) Set(string, string) error   { return nil }
func (testCredentialStore) Get(string) (string, error) { return "", nil }
