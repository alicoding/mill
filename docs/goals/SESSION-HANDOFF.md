...
- **MCP is deny-all** — [corporate-proxy] blocks the port. Returns only once the
  **control plane [the-bank] is adopting** lands (to restrict *which* AI
...
**open-source it**, then `git clone` + build it at work — **[corporate-proxy] scans
